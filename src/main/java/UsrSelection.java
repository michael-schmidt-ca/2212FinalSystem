public class UsrSelection {
    /* User creates a this by entering strings into the ui this object gets past to broker factory which then creates a broker object based on the inputed strings
